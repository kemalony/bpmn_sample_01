...
- `proje_bilgisi.json`: Proje adı, kodu, lokasyon ve işveren bilgisi giriş formu.
- `proje_bilgisi.ui.json`: Proje bilgisi giriş görünüm ayarları.
- `taseron_bilgisi.json`: Taşeron firma ünvanı, vergi no ve iletişim bilgisi giriş formu.
- `taseron_bilgisi.ui.json`: Taşeron firma bilgisi giriş görünüm ayarları.
...
1. Proje adı, proje kodu, lokasyon, işveren ve proje sorumlusu bilgileri girilir.
2. Taşeron firma ünvanı, vergi no, yetkili ve iletişim bilgileri girilir.
3. Saha mühendisi hakediş no, sözleşme no, dönem, iş kapsamı, gerçekleşme oranı, talep tutarı ve destek dosyalarını girer. Proje ve taşeron bilgileri önceki ekranlardan gelir.
4. İSG uzmanı denetim tarihi, risk seviyesi, ihlal durumu, açık aksiyon sayısı, kesinti tutarı ve HSE notlarını kaydeder.
5. Proje müdürü teknik uygunluk, metraj uygunluğu ve revize hakediş tutarı üzerinden onay veya red kararı verir.
6. Finans ekibi fatura, cari hesap mutabakatı, vergi borcu yoktur belgesi, yasal kesintiler, KDV, net ödeme tutarı ve önerilen ödeme tarihini kontrol eder.
7. GM / CFO final onay tutarı, ödeme önceliği ve nihai gerekçe ile süreci onaylar veya reddeder.
